...
| # | Finding | The number |
|---|---|---|
| 1 | **Style is a phase transition, not a slope.** Nothing below ~10k training words; the voice snaps in by ~25k and plateaus at or above the rate real held-out Chesterton scores. In training time it's even sharper: fully formed by gradient step 25. | AV 0.004 → **0.718** between 10k and 25k words |
